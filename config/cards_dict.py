...
Allies_dict = {
    ...
    Allies.Gondorian_Spearman: 'Gondorian_Spearman',
    Allies.Horseback_Archer: 'Horseback_Archer',
    Allies.Beorn: 'Beorn',
}

Quests_dict = {
    Quests.Flies_and_Spiders: 'Flies_and_Spiders',
    Quests.A_fork_in_the_road: 'A_fork_in_the_road',
